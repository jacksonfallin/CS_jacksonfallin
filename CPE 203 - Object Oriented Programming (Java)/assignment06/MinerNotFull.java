...
public class MinerNotFull extends MovementEntity
{
    ...
    public void shift(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        ...
        Ashe ashe = Point.createAshe(id(), position(),  getActionPeriod(), getAnimationPeriod(), imageStore.getImageList("ashe"));
    ...
    {
        Optional<Entity> notFullTarget = world.findNearest(world, this.position(), e -> e instanceof Ore);
    ...
    public boolean alter(WorldModel world, EventScheduler scheduler, ImageStore imageStore)
    {
        ...
        {
            MinerFull miner = Point.createMinerFull(id(), resourceLimit(), position(), getActionPeriod(), getAnimationPeriod(), images());
