...
public class Ore extends ActivityAbst
{
	private static final Random rand = new Random();
    public static final String ORE_ID_PREFIX = "fire -- ";
    ...
    public void executeActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler)
    {
        ...
        OreBlob blob = Point.createOreBlob(id() + BLOB_ID_SUFFIX, pos, getActionPeriod() / BLOB_PERIOD_SCALE,
