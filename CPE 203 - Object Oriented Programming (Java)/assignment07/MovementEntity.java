...
public abstract class MovementEntity extends AnimationAbst
{
    ...
    /*public boolean moveToFull (WorldModel world, Entity target, EventScheduler scheduler)
    {
        ...
        if (Point.adjacent(getgetPosition(), (target).getgetPosition()))
        {
        ...
        {
            Point nextPos = this.nextPosition(world, target.getgetPosition());

            if (!getgetPosition().equals(nextPos))
            {
    ...
    public Point nextPosition(WorldModel world, Point destPos) 
    {
        ...
        List<Point> x = asa.computePath(getPosition(), destPos,((Point point) -> !world.isOccupied(point) && world.withinBounds(point)), (Point position) -> potentialNeighbors(position));
