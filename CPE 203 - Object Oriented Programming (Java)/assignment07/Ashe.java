...
public class Ashe extends MovementEntity 
{
    ...
    {
        Optional<Entity> blobTarget = world.findNearest(world, this.getPosition(), sch -> sch instanceof Charizard);
    ...
    public Point nextPosition(WorldModel world, Point destPos)
    {
        ...
        List<Point> x = strategy.computePath(getPosition(), destPos, ((Point point) -> !world.isOccupied(point) && world.withinBounds(point)), (Point position) -> potentialNeighbors(position));
