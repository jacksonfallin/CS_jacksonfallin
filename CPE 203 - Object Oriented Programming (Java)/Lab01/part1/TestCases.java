...
public class TestCases
{
    ...
    {
	assertEquals(17.0, SimpleIf.max(17.0, 10.0), DELTA);
    }
    ...
    assertArrayEquals(
		new int[] {36, 81},
	    SimpleArray.squareAll(new int[] {6, 9}));
    }
    ...
    {
	assertTrue(BetterLoop.contains(new int[] {6, 2, 5, 9}, 9));
    }
    ...
    {
	List<String> expected = Arrays.asList("Tom", "Tim");
	Map<String, List<Course>> courseListsByStudent = new HashMap<>();
